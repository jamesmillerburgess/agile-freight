...
import AddRateConnect from '../editors/AddRateConnect.jsx';
          ...
          <div className="app-inner">
            ...
            {loading ?
             ...
             <div className="content-container">
               ...
               <Route
                 path="/rates"
                 render={routeProps => verifyAdminAuth(AddRateConnect, {
                   ...routeProps,
                 })}
               />
               <Route
               ...
               <Route
                 path="/branches/new"
                 exact
                 render={routeProps => verifyAdminAuth(
                   EditBranchConnect,
                   routeProps,
                 )}
               />
