  ...
  describe('EditCustomer Component', () => {
    ...
    describe('Structure', () => {
      ...
      it('renders a content', () => {
        wrapper.childAt(0).hasClass('content').should.equal(true);
      });
      ...
      it('renders a link back to the customer list', () => {
        wrapper.find('.process-header').childAt(1).name().should.equal('Link');
        wrapper.find('Link').props().to.should.equal('/customers');
      });
